 ...
 * @author Andres
 */
public class ABMTipoImpuesto extends javax.swing.JFrame {

    /**
     * Creates new form ABMTipoImpuesto
     */
    private ExpertoLISTAR_IMPUESTO controlador = new ExpertoLISTAR_IMPUESTO();
    public ABMTipoImpuesto() {
        initComponents();
    }
    ...
    private void start(){
        ...
        List<DTOUsuario> listaTI;
        listaTI = controlador.buscarTipoImpuesto();
        
        DefaultListModel listModelTI = new DefaultListModel();
        
        for(DTOUsuario dtoTI: listaTI){
            String usuario = dtoTI.getUsuario();
            String contraseña = dtoTI.getContraseña();
            String elem = "(" + usuario + ") " + contraseña;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ABMTipoImpuesto().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JCheckBox chkImporteEditable;
    ...
    private javax.swing.JTextField txtNombreTipoImpuesto;
