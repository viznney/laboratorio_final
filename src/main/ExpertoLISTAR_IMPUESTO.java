...
public class ExpertoLISTAR_IMPUESTO
{
    private TipoImpuesto tipoImpuesto;
    //private UsuarioLab usuarioLab;
    
    public List<DTOUsuario> buscarTipoImpuesto(){
        ...
        EstadoUsuario m_EstadoUsuario  = (EstadoUsuario) FachadaPersistencia.getInstance().buscar("EstadoUsuario", criterioList1).get(0);
        
        List<DTOCriterio> criterioList2 = new ArrayList<>();
        DTOCriterio criterio2 = new DTOCriterio();
        criterio2.setAtributo("m_EstadoUsuario");
        criterio2.setOperacion("=");
        criterio2.setValor(m_EstadoUsuario);
        ...
        for(Object ti: listaTI){
            DTOUsuario dtoTI = new DTOUsuario();
            String usuario = ((UsuarioLab)ti).getUsuario();
            dtoTI.setUsuario(usuario);
            String contraseña = ((UsuarioLab)ti).getContraseña();
            dtoTI.setContraseña(contraseña);
            listaDTOUsuario.add(dtoTI);
        }
